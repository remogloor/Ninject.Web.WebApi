...
namespace Ninject.Web.WebApi
{
    ...
    /// </summary>
    public class NinjectDependencyResolver : NinjectDependencyResolverImplementation, IDependencyResolver
    {
        /// <summary>
    ...
    public class NinjectDependencyResolverImplementation
    {
        /// <summary>
        ...
        /// </summary>
        /// <param name="resolutionRoot">The resolution root.</param>
        public NinjectDependencyResolverImplementation(IResolutionRoot resolutionRoot)
        {
